...
class Circuit:
    def __init__(self, name, index=None, intensity=None, loss=0.002, codec='g.711'):
        """
    ...
    def edit_network(self, name, intensity, loss, codec):
        """
    ...
    def test(self):
        ...
        self.edit_network('szwesta', 345, 0.002, 'g.711')
...
class Package:
    def __init__(self, name, index=None, intensity_voice=0, intensity_video=0, intensity_be=0, codec='g.729',
        ...
        :param codec: voice codec for movement going out from the network

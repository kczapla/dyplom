...
def access_network_list_circuit(instance):
    rows = [('Network name: ', instance.__dict__['name']),
            ...
            ('Offered Load in [Erl]', instance.__dict__['intensity_voice_in']),
            ('Offered Load out [Erl]', instance.__dict__['intensity_voice_out']),
            ('Links in', instance.__dict__['links_in']),
            ('Links out', instance.__dict__['links_out']),
            ('Actual number of links in', instance.__dict__['r_in']),
            ('Actual number of links out', instance.__dict__['r_out']),
